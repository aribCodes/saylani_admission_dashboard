    ...
    <Box m="20px">
      ...
      >
        ...
        >
          <StatBox
            title={unpaidFees}
            subtitle="Students Fee's: Pending"
            progress="0.80"
            increase="+43%"
            icon={
              <AttachMoneyOutlinedIcon
        ...
        >
          ...
          >
            Pie Chart For Students By Courses
          </Typography>
          <Box height="240px">
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              sx={{ mt: "15px" }}
            >
              {progress} Student's Fee Have Been Recieved
            </Typography>
            <Typography
              variant="h5"
              ...
              sx={{ mt: "15px" }}
            >
              {unpaidFees} Student's Fee On Pending
            </Typography>
          </Box>
        </Box>
        <Box
